...
import com.example.pogonu.databinding.ActivityPogonuQuestionsBinding

class PogonuQuestionsActivity : AppCompatActivity(), View.OnClickListener {


    private val binding by lazy {
        ActivityPogonuQuestionsBinding.inflate(layoutInflater)
    }
